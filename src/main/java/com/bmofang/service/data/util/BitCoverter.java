...
public class BitCoverter {
    ...
    /**
     * 将byte数组从指定索引开始的2个字节以小端模式转换为一个Int16
     *
     * @param byteArr    字节数组
     * @param startIndex 开始索引(下标)
     * @return 能正确表示有符号16位整型的int数
     */
    public static short toInt16(byte[] byteArr, int startIndex) {
         /*int Uint16Num =0;
        for (int i = 0; i <= 1; i++) {
    ...
    /**
     * 将byte数组从指定索引开始的4个字节以小端模式转换为一个Int32
     *
     * @param byteArr    字节数组
     * @param startIndex 开始索引(下标)
     * @return 能正确表示有符号32位整型的long数
     */
    public static int toInt32(byte[] byteArr, int startIndex) {
        /*long Uint32Num = 0;
        for (int i = 0; i <= 3; i++) {
    ...
    /**
     * 将byte数组从指定索引开始的8个字节以小端模式转换为一个Int64
     *
     * @param byteArr    字节数组
     * @param startIndex 开始索引(下标)
     * @return 有符号位的64位long数。
     */
    public static long toInt64(byte[] byteArr, int startIndex) {
        /*long Uint64Num = 0;
        for (int i = 0; i <= 7; i++) {
